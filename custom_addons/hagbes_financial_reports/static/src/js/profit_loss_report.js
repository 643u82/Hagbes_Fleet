...
export class ProfitLossReport extends Component {
    static template = "custom_financial_reports.ProfitLossReport";
    ...
    async loadData() {
        ...
        try {
            // CALLING PROFIT LOSS REPORT MODEL
            this.state.data = await this.orm.call(
                "report.custom_financial_reports.report_profit_loss",
                "get_report_data",
                [options]
            );
        } finally {
    ...
    async printPdf() {
        ...
        await this.action.doAction({
            ...
            report_name: 'custom_financial_reports.action_report_profit_loss',
            report_file: 'custom_financial_reports.report_profit_loss',
            data: data,
        });
    }
    ...
    async exportXlsx() {
        ...
        await this.action.doAction({
            type: 'ir.actions.report',
            report_type: 'xlsx',
            report_name: 'custom_financial_reports.report_profit_loss_xlsx',
            report_file: 'Profit and Loss',
            data: data,
        });
    }
...
registry.category("actions").add("custom_financial_reports.profit_loss_client_action", ProfitLossReport);
