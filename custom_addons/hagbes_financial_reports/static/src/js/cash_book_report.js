...
export class CashBookReport extends Component {
    ...
    async getReportData() {
        this.state.data = await this.orm.call(
            "report.custom_financial_reports.report_cash_book",
            "get_report_data",
            [this.state.options]
        );
    }
    ...
    async print_pdf() {
        await this.actionService.doAction({
            ...
            report_name: 'custom_financial_reports.report_cash_book',
            report_file: 'custom_financial_reports.report_cash_book',
            data: this.state.options,
            display_name: 'Cash Book',
        });
    }
}
CashBookReport.template = "CashBookTemp";
registry.category("actions").add("csh_b", CashBookReport);
