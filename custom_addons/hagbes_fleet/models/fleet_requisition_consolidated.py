...
class FleetRequisition(models.Model):
    """
    CONSOLIDATED Fleet Requisition Model - Single Source of Truth for Business Layer
    
    Responsibility: Business requests, approval workflow, rejection handling
    NO: Vehicle assignment, execution tracking, operational logic
    """
    ...
    def get_user_requisitions(self):
        ...
        elif self.env.user.has_group('hagbes_fleet.group_fleet_operator'):
