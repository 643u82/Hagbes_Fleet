...
class ResConfigSettings(models.TransientModel):
    ...
    def get_values(self):
        ...
        product_restriction = params('hagbes_sale_stock_restriction.product_restriction')
        check_stock = params('hagbes_sale_stock_restriction.check_stock')
        res.update(
    ...
    def set_values(self):
        ...
        self.env['ir.config_parameter'].sudo().set_param(
            'hagbes_sale_stock_restriction.product_restriction', self.product_restriction)
        self.env['ir.config_parameter'].sudo().set_param(
            'hagbes_sale_stock_restriction.check_stock', self.check_stock)
