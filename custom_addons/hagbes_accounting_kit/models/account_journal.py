...
class AccountJournal(models.Model):
    ...
    def action_open_reconcile(self):
        ...
        if self.type in ('bank', 'cash'):
            views = [
                (self.env.ref(
                    'hagbes_accounting_kit.account_bank_statement_line_view_kanban').id,
                 'kanban'),
                (self.env.ref(
                    'hagbes_accounting_kit.account_bank_statement_line_view_tree').id,
            ...
            return {
                ...
                'search_view_id': [
                    self.env.ref(
                        'hagbes_accounting_kit.account_bank_statement_line_view_search').id,
                    'search'],
