...
#############################################################################
{
    ...
    'assets': {
        'web.assets_backend': [
            'hagbes_accounting_kit/static/src/scss/style.scss',
            'hagbes_accounting_kit/static/src/scss/bank_rec_widget.css',
            'hagbes_accounting_kit/static/src/js/bank_reconcile_form_list_widget.js',
            'hagbes_accounting_kit/static/src/js/KanbanController.js',
            'hagbes_accounting_kit/static/src/js/ListController.js',
            'hagbes_accounting_kit/static/src/js/bank_reconcile_form_lines_widget.js',
            'hagbes_accounting_kit/static/src/js/action_manager.js',
            'hagbes_accounting_kit/static/src/xml/bank_rec_widget.xml',
            'hagbes_accounting_kit/static/src/xml/bank_reconcile_widget.xml',
        ]
    },
    'license': 'LGPL-3',
