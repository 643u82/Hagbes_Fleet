{
    ...
    'depends': [
        'hagbes_accounting_pdf_reports',
        'hagbes_asset_management',
        'hagbes_budget_control',
        'hagbes_fiscal_year',
        'hagbes_recurring_payments',
        'hagbes_daily_reports',
        'hagbes_account_followup',
    ],
    'data': [
        'security/group.xml',
        'views/menu.xml',
